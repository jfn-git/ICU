...
because they are sampled and updated under mean-imputed dynamics (App.~\ref{fig:exactcurve}
...
\begin{figure}[t]\centering
\includegraphics[width=0.68\linewidth]{penalty_tradeoff.png}
...
\label{app:figs}
This appendix collects the exact dist-$V^\star$ learning curves for the component
ablation (Fig.~\ref{fig:exactcurve}) and the figures for the supplementary analyses
of \S\ref{sec:supp} (expert projection, robustness, dead-end structure).
