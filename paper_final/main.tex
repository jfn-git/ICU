...
\begin{abstract}
ICU-Sepsis exposes a rare opportunity to exactly audit a benchmark-level
action-support failure mode in offline medical RL: although it is distilled from
real ICU trajectories, it ships tabular
