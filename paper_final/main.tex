...
under mean-imputed dynamics; Fig.~\ref{fig:ablation} (right) traces this leakage
over training, and the exact learning curves show the same method ordering
(Fig.~\ref{fig:exactcurve}). We return to this sign interpretation in the remedy spectrum,
