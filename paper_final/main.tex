...
$d_0$-weighted value gap to $V^\star$; and ``Deploy unsupp.'' is the
deployed-state inadmissible-action rate.}
\label{tab:merged}
\begin{tabular}{llccc}
\toprule
...
with mean-imputation for unseen actions, \emph{pessimistic} VI-LCB
...
text focused on the mechanism. In brief, projecting the clinician prior onto
$\Adm(s)$ removes most unsupported deployment while preserving value; the failure
