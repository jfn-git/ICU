...
% ANONYMITY: no names / affiliations in the PDF. A code repository URL is included
% in the Reproducibility statement (this is a non-anonymous course mini-conf).
% =============================================================================
...
\url{https://github.com/jfn-git/icu-sepsis-ood-supplement}.
